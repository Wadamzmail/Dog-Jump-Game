...
public class RtlFreeTypeFontGenerator extends FreeTypeFontGenerator {
	...
	public BitmapFont generateFont(FreeTypeFontGenerator.FreeTypeFontParameter parameter, RtlFreeTypeBitmapFontData data,boolean useEnglishDigits) {
		data.justUseEnglishDigits = useEnglishDigits;
		generateData(parameter, data);
		if (data.regions == null && parameter.packer != null)
		{
			data.regions = new Array();
	...
	public BitmapFont generateRtlFont(FreeTypeFontParameter parameters,boolean useEnglishDigits) {
		return generateFont(parameters , new RtlFreeTypeFontGenerator.RtlFreeTypeBitmapFontData(),useEnglishDigits);
	}
    /***
